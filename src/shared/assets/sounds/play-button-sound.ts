...
export const playButtonDown = throttle((variant: ButtonSoundVariant = "default") => {
	...
	return playSound(variant === "default" ? sounds.sfx.button_down : sounds.sfx.button_down_alt, {
		volume: 0.25,
	});
}, 2 * BUTTON_DELAY);
...
export async function playButtonUp(variant: ButtonSoundVariant = "default") {
	...
	return playSound(variant === "default" ? sounds.sfx.button_up : sounds.sfx.button_up_alt, {
		volume: 0.25,
	});
}
